 ...
 * NTOU 拍賣系統 API
 * 海大拍賣系統後端 API 文檔 - 提供註冊、登入、商品管理等功能
...
/**
 * 輸入商品屬性並針對其作排序，輸入不存在的屬性預設依照名稱排序
 */
sortBy?: string;
/**
 * 輸入desc為降序排序，輸入其他值就用升序排序
 */
order?: string;
};
...
export type GetOrderByBuyerIdParams = {
/**
 * 買家ID
 */
buyerId: string;
...
/**
 * 更新當前使用者的詳細資訊。所有欄位都是可選的，未提供的欄位保持不變。
 * @summary 更新使用者資訊
 */
...
/**
 * 將商品狀態改為 UNAVAILABLE（已下架），商品將不可購買
 * @summary 下架商品
 */
...
/**
 * 將商品設定為拍賣模式，需指定起標價和結束時間。時間格式為 ISO 8601 (yyyy-MM-ddTHH:mm:ss)
 * @summary 建立拍賣商品
 */
...
/**
 * 對指定商品進行出價，出價金額必須高於當前最高出價，注意下方範例ID已經對應到測試用的商品，可以放心測試
 * @summary 競標出價
 */
...
/**
 * 新使用者註冊帳號。註冊成功後會自動登入並返回 JWT Token。
 * @summary 使用者註冊
 */
...
/**
 * 登出系統。由於 JWT 是無狀態的，客戶端需要刪除儲存的 Token。Token 會在 30 分鐘後自動過期失效。
 * @summary 使用者登出
 */
export const logout = (
     options?: AxiosRequestConfig
...
/**
 * 使用者登入系統。登入成功後返回 JWT Token，前端需要在後續請求的 Authorization Header 中攜帶此 Token。
 * @summary 使用者登入
 */
export const login = (
...
/**
 * 查詢指定買家（buyerID）所建立的所有訂單
 * @summary 依照買家ID搜尋訂單
 */
export const getOrderByBuyerId = (
    params: GetOrderByBuyerIdParams, options?: AxiosRequestConfig
...
export const getGetOrderByBuyerIdQueryKey = (params?: GetOrderByBuyerIdParams,) => {
    return [
    `/api/orders/buyer`, ...(params ? [params]: [])
    ] as const;
    }

    
export const getGetOrderByBuyerIdQueryOptions = <TData = Awaited<ReturnType<typeof getOrderByBuyerId>>, TError = AxiosError<unknown>>(params: GetOrderByBuyerIdParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getOrderByBuyerId>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {

const {query: queryOptions, axios: axiosOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetOrderByBuyerIdQueryKey(params);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof getOrderByBuyerId>>> = ({ signal }) => getOrderByBuyerId(params, { signal, ...axiosOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getOrderByBuyerId>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetOrderByBuyerIdQueryResult = NonNullable<Awaited<ReturnType<typeof getOrderByBuyerId>>>
export type GetOrderByBuyerIdQueryError = AxiosError<unknown>


export function useGetOrderByBuyerId<TData = Awaited<ReturnType<typeof getOrderByBuyerId>>, TError = AxiosError<unknown>>(
 params: GetOrderByBuyerIdParams, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getOrderByBuyerId>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getOrderByBuyerId>>,
          TError,
          Awaited<ReturnType<typeof getOrderByBuyerId>>
        > , 'initialData'
      >, axios?: AxiosRequestConfig}
...
export function useGetOrderByBuyerId<TData = Awaited<ReturnType<typeof getOrderByBuyerId>>, TError = AxiosError<unknown>>(
 params: GetOrderByBuyerIdParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getOrderByBuyerId>>, TError, TData>>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary 依照買家ID搜尋訂單
...
export function useGetOrderByBuyerId<TData = Awaited<ReturnType<typeof getOrderByBuyerId>>, TError = AxiosError<unknown>>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getGetOrderByBuyerIdQueryOptions(params,options)
 ...
 * @summary 查詢聊天歷史
 */
export const findChatMessages = (
    senderId: string,
    recipientId: string, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<Message[]>> => {
    
    
    return axios.default.get(
      `/api/messages/${senderId}/${recipientId}`,options
    );
  }
...
export const getFindChatMessagesQueryKey = (senderId?: string,
    recipientId?: string,) => {
    return [
    `/api/messages/${senderId}/${recipientId}`
    ] as const;
    }

    
export const getFindChatMessagesQueryOptions = <TData = Awaited<ReturnType<typeof findChatMessages>>, TError = AxiosError<unknown>>(senderId: string,
    recipientId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof findChatMessages>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {

const {query: queryOptions, axios: axiosOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getFindChatMessagesQueryKey(senderId,recipientId);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof findChatMessages>>> = ({ signal }) => findChatMessages(senderId,recipientId, { signal, ...axiosOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(senderId && recipientId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof findChatMessages>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type FindChatMessagesQueryResult = NonNullable<Awaited<ReturnType<typeof findChatMessages>>>
export type FindChatMessagesQueryError = AxiosError<unknown>


export function useFindChatMessages<TData = Awaited<ReturnType<typeof findChatMessages>>, TError = AxiosError<unknown>>(
 senderId: string,
    recipientId: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof findChatMessages>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof findChatMessages>>,
          TError,
          Awaited<ReturnType<typeof findChatMessages>>
        > , 'initialData'
      >, axios?: AxiosRequestConfig}
...
export function useFindChatMessages<TData = Awaited<ReturnType<typeof findChatMessages>>, TError = AxiosError<unknown>>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getFindChatMessagesQueryOptions(senderId,recipientId,options)
...
/**
 * 檢查指定商品是否在使用者的收藏清單中，常用於商品頁面顯示「已收藏」狀態
...
export const getGetUserChatRoomsQueryKey = (userId?: string,) => {
    return [
...
export const getGetUserChatRoomsQueryOptions = <TData = Awaited<ReturnType<typeof getUserChatRooms>>, TError = AxiosError<unknown>>(userId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getUserChatRooms>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {

const {query: queryOptions, axios: axiosOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetUserChatRoomsQueryKey(userId);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof getUserChatRooms>>> = ({ signal }) => getUserChatRooms(userId, { signal, ...axiosOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(userId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getUserChatRooms>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetUserChatRoomsQueryResult = NonNullable<Awaited<ReturnType<typeof getUserChatRooms>>>
export type GetUserChatRoomsQueryError = AxiosError<unknown>


export function useGetUserChatRooms<TData = Awaited<ReturnType<typeof getUserChatRooms>>, TError = AxiosError<unknown>>(
 userId: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getUserChatRooms>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getUserChatRooms>>,
          TError,
          Awaited<ReturnType<typeof getUserChatRooms>>
        > , 'initialData'
      >, axios?: AxiosRequestConfig}
...
export function useGetUserChatRooms<TData = Awaited<ReturnType<typeof getUserChatRooms>>, TError = AxiosError<unknown>>(
 userId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getUserChatRooms>>, TError, TData>>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary 查詢使用者的所有聊天室列表
...
export function useGetUserChatRooms<TData = Awaited<ReturnType<typeof getUserChatRooms>>, TError = AxiosError<unknown>>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getGetUserChatRoomsQueryOptions(userId,options)
