...
export const getGetCurrentUserQueryOptions = <TData = Awaited<ReturnType<typeof getCurrentUser>>, TError = AxiosError<UserInfoResponse | UserInfoResponse>>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getCurrentUser>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {
...
export const getAddToCartMutationOptions = <TError = AxiosError<string | string>,
...
const {mutation: mutationOptions, axios: axiosOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AddToCartMutationError = AxiosError<string | string>

    /**
 * @summary 加入商品到購物車
 */
export const useAddToCart = <TError = AxiosError<string | string>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof addToCart>>, TError,{data: AddToCartRequest}, TContext>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient): UseMutationResult<
...
export const findChatMessages = (
    senderId: number,
    recipientId: number, options?: AxiosRequestConfig
...
export const getFindChatMessagesQueryKey = (senderId?: number,
    recipientId?: number,) => {
    return [
...
export const getFindChatMessagesQueryOptions = <TData = Awaited<ReturnType<typeof findChatMessages>>, TError = AxiosError<Message[]>>(senderId: number,
    recipientId: number, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof findChatMessages>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {
...
export type FindChatMessagesQueryError = AxiosError<Message[]>


export function useFindChatMessages<TData = Awaited<ReturnType<typeof findChatMessages>>, TError = AxiosError<Message[]>>(
 senderId: number,
    recipientId: number, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof findChatMessages>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
